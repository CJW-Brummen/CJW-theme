...
add_action('customize_register', 'cjw_theme_customize_register');
 ...
 * @return void
 */
function cjw_theme_customize_partial_blogname()
{
    bloginfo('name');
}
 ...
 * @return void
 */
function cjw_theme_customize_partial_blogdescription()
{
...
add_action('customize_preview_init', 'cjw_theme_customize_preview_js');
