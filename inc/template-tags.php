...
if (! function_exists('cjw_brummen_posted_on')) :
    /**
    ...
    function cjw_brummen_posted_on(): void
    {
        ...
        $posted_on = sprintf(
            ...
            esc_html_x('Posted on %s', 'post date', 'cjw-brummen'),
...
if (! function_exists('cjw_brummen_posted_by')) :
    /**
...
if (! function_exists('cjw_brummen_entry_footer')) :
    /**
    ...
    function cjw_brummen_entry_footer(): void
    {
        ...
        if ('post' === get_post_type()) {
            ...
            $categories_list = get_the_category_list(esc_html__(', ', 'cjw-brummen'));
            if ($categories_list) {
                /* translators: 1: list of categories. */
                printf('<span class="cat-links">' . esc_html__('Posted in %1$s', 'cjw-brummen') . '</span>', $categories_list); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            }

            /* translators: used between list items, there is a space after the comma */
            $tags_list = get_the_tag_list('', esc_html_x(', ', 'list item separator', 'cjw-brummen'));
            if ($tags_list) {
                /* translators: 1: list of tags. */
                printf('<span class="tags-links">' . esc_html__('Tagged %1$s', 'cjw-brummen') . '</span>', $tags_list); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            }
        }
            ...
            comments_popup_link(
                sprintf(
                    wp_kses(
                        ...
                        __('Leave a Comment<span class="screen-reader-text"> on %s</span>', 'cjw-brummen'),
                        [
                            'span' => [
                                'class' => [],
                            ],
...
if (! function_exists('cjw_brummen_post_thumbnail')) :
    /**
